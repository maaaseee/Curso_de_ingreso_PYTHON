...
apellido: Aieta
---
Ejercicio: entrada_salida_extra_01
---
Enunciado:
...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.label1 = customtkinter.CTkLabel(master=self, text="Dolar oficial")
        self.label1.grid(row=0, column=0, padx=20, pady=10)
        
        self.txt_operador_a = customtkinter.CTkEntry(master=self)
        self.txt_operador_a.grid(row=0, column=1)
        
        self.label2 = customtkinter.CTkLabel(master=self, text="Dolar blue")
    ...
    def btn_sumar_on_click(self):
        ...
        sum = (operador_a) / (operador_b)
        sum2 = sum - 1
        sum3 = sum2 * 100
        
        resultado_positivo = abs(sum3)

        alert("Resultado" , f"La diferencia entre el dolar blue y el dolar oficial es del {round(resultado_positivo)}%")
